    ...
    public partial class Form1 : Form
    {
        ...
        private void btnaleatorios_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                miEmpleadoArreglo = new Empleado[500]; //intNumeroDeTamaño
                string[] Nombre = new string[] {"Cristiano Ronaldo","Lionel Andres Messi ", "Neymar Santos Jr", "Toni kros ", "Federico Valverde", "Javier Hernandez", "Vinicius Junior ", "Kyliam Mbbape ",
                "Angel Dimaria  ", "Ronaldo Nazario", "Paquito Rico ", "Manuel neur", "Hugo Sanchez", "Jesucristo", "Sergio Ramos", "El bicho" };
        ...
        private void btnmetodoordenamiento_Click(object sender, EventArgs e)
        {
            ...
            if(rbtadecendente.Checked)
            {
                int Comparaciones = 0, Movimientos = 0, MiliSegundos = 0;
                DateTime tiempoInicio = DateTime.Now;
                Ordenamiento<Empleado>.BurbujaDerecha(miEmpleadoArreglo, Ordenamiento<Empleado>.Descendente, out Comparaciones, out Movimientos, out MiliSegundos);
                MostrarDatos();
                MessageBox.Show("N° Comparaciones: " + Comparaciones +
                    "\nN° Intercambios: " + Movimientos +
                    "\nDuracion del ordenado: " + MiliSegundos.ToString() + " ms", "METODO BURBUJA DERECHA (DECENDENTE)");
            }
