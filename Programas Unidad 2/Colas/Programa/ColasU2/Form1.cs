...
namespace ColasU2
{
    ...
    {
        ClaseColaDinamicaDesordenada<ArregloFlorar> miArregloList = new ClaseColaDinamicaDesordenada<ArregloFlorar>();
        public Form1()
        {
            InitializeComponent();
        }
        ...
        private void btnEncolar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    miArregloList.Encolar(miflorar);
                }
        ...
        private ArregloFlorar selecionarRenglon()
        {
            ...
            MISelecionar = miArregloList.Buscar(MISelecionar);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                miarreglo = miArregloList.Buscar(miarreglo);
        ...
        private void btnDesencolar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MessageBox.Show("Quiere eleminar el objeto" + "?", "eliminar areglo ", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    miArregloFlor = miArregloList.Desencolar();
                    ...
                    MessageBox.Show("Numero de venta: " + miArregloFlor.NumeroVenta + "\n" + "precio " + miArregloFlor.Precio + "\n"
                            ...
                            + "El tiempo en milisenguos es " + (miArregloFlor.CalcularTiempo()) + "\n"
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                unArregloF = miArregloList.Buscar(unArregloF);
                if (unArregloF != null)
                {
        ...
        private void btnDesencolarPa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MessageBox.Show("Quiere eleminar el objeto" + "?", "eliminar areglo ", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    miArregloFlor = miArregloList.Desencolar(miArregloFlor);
